...
import dev.example.community.service.AreaService;
...
public class AreaController {
    ...
    public ResponseEntity<AreaDto> findCloseArea(@RequestParam(name = "latitude", required = false, defaultValue = "") String latitude,
                                                 @RequestParam(name = "longitude", required = false, defaultValue = "") String longitude) {

        return ResponseEntity.ok(this.areaService.findCloseArea(latitude, longitude));
    }
}
