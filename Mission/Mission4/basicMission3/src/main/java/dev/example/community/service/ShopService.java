...
import dev.example.community.controller.dto.ShopDto;
import dev.example.community.controller.dto.ShopPostDto;
import dev.example.community.controller.dto.ShopReviewDto;
import dev.example.community.entity.*;
import dev.example.community.repository.*;
import dev.example.community.entity.*;
import dev.example.community.repository.*;
